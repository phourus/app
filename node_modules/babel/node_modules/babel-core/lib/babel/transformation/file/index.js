...
var File = (function () {
  ...
  File.prototype.buildTransformers = function buildTransformers() {
    ...
    _each2["default"](_transform2["default"].transformers, function (transformer, key) {
  ...
  File.prototype.getModuleFormatter = function getModuleFormatter(type) {
    var ModuleFormatter = _isFunction2["default"](type) ? type : _transform2["default"].moduleFormatters[type];
